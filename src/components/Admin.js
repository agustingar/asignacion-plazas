                  ...
                  return (
                    <div key={index} style={{
                      ...
                      <div style={{ 
                        fontSize: '14px', 
                        marginTop: '5px',
                        color: centroSeleccionadoReasignacion === centroId ? '#d32f2f' : '#388e3c',
                        fontWeight: 'bold'
                      }}>
                        Plazas: <strong>{centro.plazasDisponiblesActualizadas}</strong> disponibles 
                        de {centro.plazasTotal || centro.plazas || 0}
                        {centroSeleccionadoReasignacion === centroId && ' - SELECCIONADO'}
                      </div>
                    </div>
                  );
                })}
                ...
                .map((centro, index) => (
                  <div key={index} style={{
                    ...
                    <div style={{ 
                      fontSize: '14px', 
                      marginTop: '5px',
                      color: centroSeleccionadoReasignacion === centro.id ? '#d32f2f' : '#388e3c',
                      fontWeight: 'bold'
                    }}>
                      Plazas: <strong>{centro.plazasDisponiblesActualizadas}</strong> disponibles 
                      de {centro.plazasTotal || centro.plazas || 0}
                      {centroSeleccionadoReasignacion === centro.id && ' - SELECCIONADO'}
                    </div>
                  </div>
                ))}
            </div>
